...
This simulator is built in JavaFX and provides a modular structure for creating and launching rockets with different components and mission profiles. It includes:
...
- `RocketSimulatorApp` - main entry point for the application, controlled by RocketSimulatorApp.java
